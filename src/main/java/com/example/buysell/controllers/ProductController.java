...
public class ProductController {
    ...
    @PostMapping("/product/end/{id}")
    public String endProduct(@PathVariable Long id, Principal principal) {
        productService.givehour(productService.getUserByPrincipal(principal), id);
        productService.deleteProduct(productService.getUserByPrincipal(principal), id);
        return "redirect:/my/products";
    }
